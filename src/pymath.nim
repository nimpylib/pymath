## 
## *The following is from repo's README*
## 
## .. include:: ../README.md
## 
...
from ./pymath/platformUtils import CLike, clikeOr, impJsOrC
from ./pymath/errnoUtils import
...
macro impPatch(sym) =
  #import ./pymath/patch/sym
  # HINT: using `template (sym) = import ./pymath/patch/sym`
...
func lgamma*[F: SomeFloat](x: F): F =
  ...
  of geGotNegInf: discard  # pymath/patch.lgamma alreadly returns +inf
